...
$rc_nominativo = getNomeClienteByCOdice($rc_cl_codice, $dbConn);
    ...
    $querySql =
        "INSERT INTO rc_recensioni(rc_cl_codice, rc_pr_codice, rc_nominativo, rc_testo, rc_voto, rc_timestamp, rc_pr_id, rc_stato) VALUES" .
        "('$rc_cl_codice', '$rc_pr_codice', '$rc_nominativo', '$rc_testo', '$rc_voto', '$rc_timestamp', '$rc_pr_id', 1)";

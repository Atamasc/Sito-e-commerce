                        ...
                        <div class="col-xl-12 mb-30">
                            ...
                            <div class="card card-statistics mb-10">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="prodotti-immagini-add-do.php" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-1 table-bordered table-striped mb-0">
                                            ...
                                            <?php
                                            $querySql = "SELECT * FROM pi_prodotti_immagini WHERE pi_pr_id = $get_pr_id ORDER BY pi_id ASC";
                                            ...
                                            while (($row_data = $result->fetch_assoc()) !== NULL) {
                                                ...
                                                echo "<a class='btn btn-success btn-sm' href='prodotti-immagini-mod.php?pi_id=$pi_id&pr_id=$get_pr_id' title='Modifica'>modifica</a>&nbsp;";
                                                echo "<button class='btn btn-danger btn-sm elimina' data-href='prodotti-immagini-del-do.php?pi_id=$pi_id&pr_id=$get_pr_id'><i class='fas fa-trash-alt'></i></button>";
                                                echo "</td>";
                                                echo "</tr>";

...
$querySql =
    "INSERT INTO mr_marche(" .
    "mr_titolo, mr_codice, mr_immagine, mr_descrizione, mr_timestamp, mr_stato" .
    ") VALUES (" .
    "'$mr_titolo', '$mr_codice', '$mr_immagine', '$mr_descrizione', '$mr_timestamp', 1)";
$result = $dbConn->query($querySql);
$rows = $dbConn->affected_rows;

$insert = $rows > 0 ? 'true' : 'false';
header("Location: marche-add.php?insert=$insert");
?>
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <p class="text-muted pt-3 mb-0 mt-2 border-top">
                    <i class="fa fa-exclamation-circle mr-1" aria-hidden="true"></i> <a href="clienti-gst.php">Gestisci i clienti</a>
                </p>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <p class="text-muted pt-3 mb-0 mt-2 border-top">
                    <i class="fa fa-exclamation-circle mr-1" aria-hidden="true"></i> <a href="prodotti-gst.php">Gestisci i prodotti</a>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <p class="text-muted pt-3 mb-0 mt-2 border-top">
                    ...
                    <b><?php echo countOrdiniEvasi(); ?></b> <a href="ordini-gst.php?or_stato=1" title="Ordini Evasi" style="color: #257BEB;">Evasi</a> |
                    <b><?php echo countOrdiniSospesi(); ?></b> <a href="ordini-gst.php?or_stato_pagamento=0" title="Ordini non pagati" style="color: #257BEB;">Sospesi (Non Pagati)</a> |
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="clearfix">
                    <div class="float-left">
                  <span class="text-primary">
                    <i class="fas fa-blog highlight-icon" aria-hidden="true"></i>
                  </span>
                    </div>
                    <div class="float-right text-right">
                        <p class="card-text text-dark">Post blog</p>
                        <h4><?php echo countPostBlog($dbConn); ?></h4>
                    </div>
                </div>
                <p class="text-muted pt-3 mb-0 mt-2 border-top">
                    <i class="fa fa-exclamation-circle mr-1" aria-hidden="true"></i> <a href="blog-gst.php">Gestisci il blog</a>

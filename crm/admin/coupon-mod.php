                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select class="form-control" id="co_mr_codice" name="co_mr_codice">
                                                    ...
                                                    <option value="">Valido su tutte le marche</option>
                                                    <?php selectCodiceMarca($row_data['co_mr_codice']); ?>
                                                </select>
                                                <span class="tooltips">Marca Coupon <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Marca Coupon" data-content="Inserisci qui la marca che ha rilasciato il coupon che stai modificando">[aiuto]</a></span>
                                            </div>
                                            ...
                                            <div class="col-md-2 mb-3">
                                                ...
                                                <span class="tooltips">Valore Coupon <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Valore Coupon" data-content="Inserisci qui il valore del coupon che stai modificando">[aiuto]</a></span>
                                            ...
                                            <div class="col-md-2 mb-3">
                                                ...
                                                <span class="tooltips">Utilizzi Coupon <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Valore Coupon" data-content="Inserisci qui il numero di utilizzi massimo per utente per questo coupon">[aiuto]</a></span>

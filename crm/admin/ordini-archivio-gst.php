                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-1 table-bordered table-striped mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center" width="120">Archivio</th>
                                                <th class="text-center" width="260">Gestione</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            while (($row_data = $result->fetch_assoc()) !== NULL) {
                                                ...
                                                echo "<td class='text-center'><button class='btn btn-info btn-sm alert-link-ordini-riprisrtina' style='font-weight: normal;' data-href='ordini-archivio-do.php?or_codice=$or_codice' title='archivio'>ripristina</button></td>";

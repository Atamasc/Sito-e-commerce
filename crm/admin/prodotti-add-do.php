...
$pr_timestamp = time();
$pr_best_seller = $_POST['best_seller'];
$pr_best = $pr_best_seller = 'on'? 1 : 0;
...
$querySql =
    ...
    "pr_ct_id, pr_st_id, pr_mr_id, pr_codice, pr_codice_rif, pr_codice_ean, pr_titolo, pr_abstract, pr_descrizione, pr_prezzo, ".
    "pr_prezzo_scontato, pr_sconto, pr_prezzo_acquisto, pr_peso, pr_giacenza, pr_si_id, pr_formato, pr_allegato, pr_immagine, pr_note, pr_timestamp, pr_stato,pr_best_seller".
    ") VALUES (".
    "'$pr_ct_id', '$pr_st_id', '$pr_mr_id', '$pr_codice', '$pr_codice_rif', '$pr_codice_ean', '$pr_titolo', '$pr_abstract', '$pr_descrizione', '$pr_prezzo', ".
    "'$pr_prezzo_scontato', '$pr_sconto', '$pr_prezzo_acquisto', '$pr_peso', '$pr_giacenza', '$pr_si_id', '$pr_formato', '$pr_allegato', '$pr_immagine', '$pr_note', '$pr_timestamp', 1,'$pr_best') ";

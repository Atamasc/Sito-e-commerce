                                    ...
                                    <form method="post" action="prodotti-varianti-add-do.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select class="form-control" id="pr_ct_id" name="pr_ct_id" required disabled>
                                                ...
                                                <span class="tooltips">Inserisci qui la categoria del tuo prodotto <a tabindex="0" style="color: blue; cursor: pointer;" role="button" data-toggle="popover" data-trigger="focus" title="Categoria Prodotto" data-content="Assegna una categoria al tuo prodotto.">[aiuto]</a></span>
                                            </div>

                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <input name="cr_codice" id="cr_codice" class="form-control" type="text" autocomplete="off"
                                                   value="<?php echo $get_cr_codice; ?>">
                                            <span class="tooltips">Codice Cliente <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Codice CLiente" data-content="Inserisci qui il codice del cliente associato al carrello che stai cercando">[aiuto]</a></span>
                                        </div>

                                        <div class="col-md-2 mb-3">
                                            <label for="cr_email">Email</label>
                                            <input name="cr_email" id="cr_email" class="form-control" type="text" autocomplete="off"
                                                   value="<?php echo $get_cr_email; ?>">
                                            <span class="tooltips">Email Cliente <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Email CLiente" data-content="Inserisci qui l'email del cliente associato al del carrello che stai cercando">[aiuto]</a></span>
                                        </div>

...
$querySql = "SELECT mr_immagine FROM mr_marche WHERE mr_id = $get_mr_id";
...
$querySql = "DELETE FROM mr_marche WHERE mr_id = $get_mr_id";
$result = $dbConn->query($querySql);
$rows = $dbConn->affected_rows;

$delete = $rows > 0 ? 'true' : 'false';
header("Location: marche-gst.php?mr_id=$get_mr_id&delete=$delete");
?>
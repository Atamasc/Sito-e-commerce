<?php include "inc/autoloader.php"; ?>
    ...
    $get_ct_titolo = isset($_GET['ct_titolo']) ? $dbConn->real_escape_string(stripslashes(trim($_GET['ct_titolo']))) : "";
    ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-1 table-bordered table-striped mb-0">
                                            ...
                                            if(strlen($get_ct_titolo) > 0) $querySql .= " AND ct_titolo LIKE '%$get_ct_titolo%' ";
                                            ...
                                            if(strlen($get_ct_titolo) > 0) $querySql .= " AND ct_titolo LIKE '%$get_ct_titolo%' ";
                                            $querySql .= " ORDER BY ct_titolo LIMIT $primo, $per_page";
                                            $result = $dbConn->query($querySql);
                                            ...
                                            if ($row_data['ct_stato'] == 0) { ?>
                                                <div class="checkbox checbox-switch switch-success">
                                                    <label>
                                                        <input type="checkbox" class="stato" title="categoria-stato-do.php?ct_id=<?php echo $ct_id; ?>"><span></span>
                                                    </label>
                                                </div>
                                            <?php } else { ?>
                                                <div class="checkbox checbox-switch switch-success">
                                                    <label>
                                                        <input type="checkbox" class="stato" title="categoria-stato-do.php?ct_id=<?php echo $ct_id; ?>" checked><span></span>
                                                    </label>
                                                </div>
                                            <?php }
                                            ...
                                            echo "</td>";
                                                ...
                                                echo "<button class='btn btn-danger btn-sm elimina' data-href='categoria-del-do.php?ct_id=$ct_id'>elimina</button>";
                                                echo "</td>";
                                                echo "</tr>";

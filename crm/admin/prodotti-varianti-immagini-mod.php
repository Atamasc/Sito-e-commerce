<?php include "inc/autoloader.php"; ?>
    ...
    $pv_pr_id = isset($_GET["pr_id"]) ? (int)$_GET["pr_id"] : 0;

    $querySql_im = "SELECT * FROM pv_prodotti_varianti_immagini WHERE pv_id = $pv_id ";
                        ...
                        <div class="col-xl-12 mb-30">
                            ...
                            <div class="card card-statistics mb-10">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="prodotti-varianti-immagini-mod-do.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label for="pv_descrizione">Titolo</label>
                                                <input type="text" name="pv_descrizione" class="form-control" value="<?php echo $row_data['pv_descrizione']; ?>">
                                            </div>

                                            <div class="col-md-4">
                                                <label>&nbsp;</label>
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="customFile" name="pv_immagine">
                                                    <label class="custom-file-label" for="customFile"><?php echo $row_data['pv_immagine']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <input type="hidden" name="pv_id" value="<?php echo $pv_id; ?>" />
                                            <input type="hidden" name="pv_pr_id" value="<?php echo $pv_pr_id; ?>" />
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-1 table-bordered table-striped mb-0">
                                            ...
                                            <?php
                                            $querySql = "SELECT * FROM pv_prodotti_varianti_immagini WHERE pv_pr_id = $pv_pr_id ORDER BY pv_id ASC";
                                            ...
                                            while (($row_data = $result->fetch_assoc()) !== NULL) {
                                                ...
                                                echo "<a class='btn btn-success btn-sm' href='prodotti-varianti-immagini-mod.php?pv_id=$pv_id&pr_id=$pv_pr_id' title='Modifica'>modifica</a>&nbsp;";
                                                echo "<button class='btn btn-danger btn-sm elimina' data-href='prodotti-varianti-immagini-del-do.php?pv_id=$pv_id&pr_id=$pv_pr_id'><i class='fas fa-trash-alt'></i></button>";
                                                echo "</td>";
                                                echo "</tr>";

...
$pr_peso = formatPriceForDB($dbConn->real_escape_string(stripslashes(trim($_POST['pr_peso']))));
...
if ($esistenza_varianti > 0) {
    ...
    $querySql2 =
        ...
        "pr_ct_id = '$pr_ct_id', pr_mr_id = '$pr_mr_id' " .
...
$querySql =
    "UPDATE pr_prodotti SET " .
    "pr_ct_id = '$pr_ct_id', pr_mr_id = '$pr_mr_id', pr_titolo = '$pr_titolo', pr_codice = '$pr_codice', " .
    "pr_prezzo = '$pr_prezzo', pr_prezzo_scontato = '$pr_prezzo_scontato', pr_sconto = '$pr_sconto', " .
    "pr_peso = '$pr_peso', pr_giacenza = '$pr_giacenza', pr_immagine = '$pr_immagine', " .

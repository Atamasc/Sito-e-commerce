                                ...
                                <div class="card-body">
                                    <form method="post" action="#" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <label for="pr_codice_marche">Codice marca</label>
                                                <input type="text" class="form-control" id="pr_codice_marche" name="pr_codice_marche"
                                                        value="<?php echo $row_data['pr_codice_marche']; ?>" readonly>
                                            </div>

                                            <div class="col-md-3 mb-3">
                                                <label for="pt_descrizione_marche">Descrizione marca</label>
                                                <input type="text" class="form-control" id="pt_descrizione_marche" name="pt_descrizione_marche"
                                                        value="<?php echo $row_data['pt_descrizione_marche']; ?>" readonly>
                                            </div>

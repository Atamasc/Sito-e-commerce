...
$querySql = "SELECT * FROM mr_marchi WHERE mr_id = '$get_mr_id' ";
$result = $dbConn->query($querySql);
$row_data = $result->fetch_assoc();
$result->close();

$mr_immagine = $row_data['mr_immagine'];
$mr_immagine_path = "$upload_path_dir_marchi/$mr_immagine";
?>
<!DOCTYPE html>
<html lang="it">
        ...
        <div class="row">
            ...
            <div class="content-wrapper">
                <div class="page-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h4 class="mb-0"> Modifica marchio</h4>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                                <li class="breadcrumb-item"><a href="dashboard.php" class="default-color">Home</a></li>
                                <li class="breadcrumb-item"><a href="marchi-gst.php" class="default-color">Gestione marchi</a></li>
                                <li class="breadcrumb-item active">Modifica marchio</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12 mb-30">
                        ...
                        <div class="card card-statistics">
                            <div class="card-body">
                                ...
                                <form method="post" action="marchi-mod-do.php" enctype="multipart/form-data">

                                    <h5 class="card-title">Modifica marchio</h5>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="mr_marchio" name="mr_marchio"
                                                   value="<?php echo $row_data['mr_marchio']; ?>" required>
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <small class="text-muted">
                                                ...
                                                <?php if(strlen($mr_immagine) > 0) { ?>
                                                    <br><a class="text-success popover-img" target="_blank" href="<?php echo $mr_immagine_path; ?>">vedi immagine</a>
                                                <?php } ?>
                                            </small>
                                        </div>

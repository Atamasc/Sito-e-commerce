        ...
        <div class="row">
            ...
            <div class="content-wrapper">
                <div class="page-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h4 class="mb-0"> Aggiungi spedizioniere</h4>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                                <li class="breadcrumb-item"><a href="dashboard.php" class="default-color">Home</a></li>
                                <li class="breadcrumb-item"><a href="spedizionieri-gst.php" class="default-color">Gestione spedizioniere</a></li>
                                <li class="breadcrumb-item active">Aggiungi spedizioniere</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12 mb-30">
                        ...
                        <div class="card card-statistics">
                            <div class="card-body">
                                ...
                                <form method="post" action="spedizionieri-add-do.php" enctype="multipart/form-data">

                                    <h5 class="card-title">Aggiungi spedizioniere</h5>
                                    ...
                                    if(@$_GET['insert'] == 'true') {
                                        ...
                                        <div class="alert alert-success" role="alert">
                                            Spedizioniere inserito con successo.
                                        </div>
                                        <?php
                                    ...
                                    <a href="spedizionieri-gst.php" class="btn btn-success">Modifica spedizionieri</a>

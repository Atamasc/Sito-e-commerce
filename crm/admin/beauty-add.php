                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="beauty-gst.php" class="default-color">Gestione beauty assistant</a>
                                    </li>
                                    ...
                                    <form method="post" action="beauty-add-do.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <span class="tooltips">Password Utente <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Password Utente" data-content="Inserisci qui la password dell'utente che stai aggiungendo">[aiuto]</a></span>
                                            </div>

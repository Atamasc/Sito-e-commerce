            ...
            <div class="row">
                ...
                <div class="content-wrapper">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="mb-0"> Aggiungi corrieri</h4>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="corrieri-gst.php" class="default-color">Gestione corrieri</a></li>
                                    <li class="breadcrumb-item active">Modifica corrieri</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12 mb-30">
                            ...
                            <div class="card card-statistics">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="corrieri-mod-do.php" enctype="multipart/form-data">

                                        <h5 class="card-title">Modifica corriere</h5>
                                        ...
                                        if (@$_GET['update'] == 'true') {
                                            ...
                                            <div class="alert alert-success" role="alert">
                                                Corriere modificato con successo.
                                            </div>
                                            <?php

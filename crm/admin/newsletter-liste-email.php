                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="newsletter-gst.php" class="default-color">Gestione newsletter</a></li>
                                    <li class="breadcrumb-item">
                                        <a href="newsletter-liste-gst.php?ns_id=<?php echo $get_ns_id; ?>" class="default-color">Gestione liste</a>
                                    </li>
                                    ...
                                    <form method="post" action="newsletter-liste-email-do.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-12 mb-3">
                                                <b>Attenzione!</b> Se una email è presente in entrambe le liste verrà settata come non attiva
                                            </div>
                                        ...
                                        <a class="btn btn-orange" href="newsletter-liste-email-utenti-do.php?ne_ns_id=<?php echo $get_ns_id; ?>">Importa clienti</a>

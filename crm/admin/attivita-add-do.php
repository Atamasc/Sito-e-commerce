...
$querySql =
    ...
    "at_ut_id, at_tipologia, at_luogo, at_esito, at_ora_attivita, at_data_attivita, at_note, at_data, at_stato".
    ") VALUES (".
    "'$at_ut_id', '$at_tipologia', '$at_luogo', '$at_esito', '$at_ora_attivita', '$at_data_attivita', '$at_note', '$at_data', 1)";

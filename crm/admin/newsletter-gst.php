                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-1 table-bordered table-striped mb-0">
                                        ...
                                        while (($row_data = $result->fetch_assoc()) !== NULL) {
                                            ...
                                            echo strlen($row_data['nl_allegato']) > 0
                                                ? "<a class='btn btn-primary btn-sm' href='$upload_path_dir_newsletter/".$row_data['nl_allegato']."' title='Visualizza' target='_blank'>allegato 1</a>&nbsp;"
                                                : "<a class='btn btn-secondary btn-sm disabled' href='javascript:;' title='Non associato'>allegato 1</a>&nbsp;";
                                            echo strlen($row_data['nl_allegato_2']) > 0
                                                ? "<a class='btn btn-primary btn-sm' href='$upload_path_dir_newsletter/".$row_data['nl_allegato_2']."' title='Visualizza' target='_blank'>allegato 2</a>&nbsp;"
                                                : "<a class='btn btn-secondary btn-sm disabled' href='javascript:;' title='Non associato'>allegato 2</a>&nbsp;";
                                            ...
                                            echo "<button class='btn btn-danger btn-sm elimina' data-href='newsletter-immagine-del-do.php?nl_id=$nl_id'><i class='fa fa-trash-alt'></i></button>";
                                            echo "</td>";
                                            echo "</tr>";

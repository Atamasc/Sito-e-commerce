...
$querySql = "SELECT or_timestamp FROM or_ordini INNER JOIN cl_clienti ON cl_codice = or_cl_codice WHERE or_codice = '$get_or_codice' LIMIT 0, 1";
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-1 table-bordered table-striped mb-0">
                            ...
                            if ($or_sconto_coupon > 0) {
                                ...
                                ?>
                                <tr>
                                    <td>Sconto (<?php echo $or_coupon; ?>)</td><td>&euro; <?php echo formatPrice($or_sconto_coupon); ?></td>
                                </tr>
                                <?php

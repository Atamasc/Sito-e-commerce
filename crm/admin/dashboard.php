        ...
        <div class="row">
           ...
           wrapper -->
            ...
            <div class="content-wrapper">
                ...
                <?php //include "inc/dashboard-ricerca.php"; ?>

                <?php include "inc/dashboard-ordini.php"; ?>

                <?php include "inc/dashboard-clienti.php"; ?>

                <?php include "inc/dashboard-campagne.php"; ?>

                <?php //include "inc/dashboard-distribuzione.php"; ?>

                <?php //include "inc/dashboard-attivita.php"; ?>

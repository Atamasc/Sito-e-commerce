                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select class="form-control" id="co_mr_codice" name="co_mr_codice" >
                                                ...
                                                <option value=""></option>
                                                <option value="" style="font-weight: bold;">Valido su tutti i marchi</option>
                                                <?php selectMarchio('', $dbConn); ?>
                                            </select>
                                            <span class="tooltips">Marchio Coupon <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Marchio Coupon" data-content="Inserisci qui il marchio che ha rilasciato il coupon che stai aggiungendo">[aiuto]</a></span>
                                        </div>
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <span class="tooltips">Valore Coupon <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Valore Coupon" data-content="Inserisci qui il valore del coupon che stai aggiungendo">[aiuto]</a></span> <small class="form-text text-muted">Inserire solo valori numerici (Es: 25.50)</small>
                                        </div>
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <span class="tooltips">Numero utilizzi <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Numero utilizzi" data-content="Inserisci qui il numero di utilizzi massimo per utente per questo coupon">[aiuto]</a></span> <small class="form-text text-muted">Inserire solo valori numerici (Es: 10)</small>
                                        </div>
                                    </div>

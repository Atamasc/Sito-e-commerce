...
$get_pr_codice_marchio = isset($_GET['pr_codice_marchio']) ? $dbConn->real_escape_string(stripslashes(trim($_GET['pr_codice_marchio']))) : "";
        ...
        <div class="row">
            ...
            <div class="content-wrapper">
                <div class="page-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h4 class="mb-0"> Gestione catalogo <i class="fas fa-chevron-double-right"></i> Lista linee</h4>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="card-body">
                                ...
                                <form method="get" action="?" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="pr_codice_marchio">Marchio</label>
                                            <select class="form-control" id="pr_codice_marchio" name="pr_codice_marchio">
                                                <option value="">Filtra per marchio</option>
                                                <option value=""></option>
                                                <?php selectMarchio($get_pr_codice_marchio); ?>
                                            </select>
                                            <span class="tooltips">Marchio Linea Prodotti <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Marchio Linea Prodotti" data-content="Inserisci qui il marchio della linea di prodotti che stai cercando">[aiuto]</a></span>
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-1 table-bordered table-striped mb-0">
                                        ...
                                        if(strlen($get_pr_codice_marchio) > 0) $querySql .= " AND pr_codice_marchio = '$get_pr_codice_marchio' ";
                                        ...
                                        $querySql =
                                            "SELECT DISTINCT pr_codice_linea, pr_descrizione_linea, pr_descrizione_marchio FROM pr_prodotti ".
                                        ...
                                        while (($row_data = $result->fetch_assoc()) !== NULL) {
                                            ...
                                            echo "<td>".$row_data['pr_descrizione_marchio']."</td>";

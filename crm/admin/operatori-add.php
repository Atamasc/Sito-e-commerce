                                    ...
                                    <form method="post" action="operatori-add-do.php">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <span class="tooltips">Nome Operatore <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Nome Operatore" data-content="Inserisci qui il nome dell'operatore che stai aggiungendo">[aiuto]</a></span>
                                            </div>

                                            <div class="col-md-3 mb-3">
                                                <label for="op_cognome">Cognome *</label>
                                                <input type="text" class="form-control" id="op_cognome" name="op_cognome" required>
                                                <span class="tooltips">Cognome Operatore <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Cognome Operatore" data-content="Inserisci qui il cognome dell'operatore che stai aggiungendo">[aiuto]</a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <span class="tooltips">Username Operatore <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Username Operatore" data-content="Inserisci qui l'usernamee dell'operatore che stai aggiungendo">[aiuto]</a></span>
                                            </div>

                                            <div class="col-md-3 mb-3">
                                                <label for="op_password">Password *</label>
                                                <input type="text" class="form-control" id="op_password" name="op_password" required>
                                                <span class="tooltips">Password Operatore <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Password Operatore" data-content="Inserisci qui la password dell'operatore che stai aggiungendo">[aiuto]</a></span>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <span class="tooltips">E-mail Operatore <a class="popup-a" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="E-mail Operatore" data-content="Inserisci qui l'e-mail dell'operatore che stai aggiungendo">[aiuto]</a></span>
                                            </div>

            ...
            <div class="row">
                ...
                <div class="content-wrapper">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="mb-0"> Ordini eliminati </h4>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="ordini-gst.php" class="default-color">Gestione ordini</a></li>
                                    <li class="breadcrumb-item active">Eliminati</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12 mb-30">
                            <div class="card card-statistics h-100">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title border-0 pb-0">Lista ordini eliminati</h5>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-1 table-bordered mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center" width="120">Eliminato</th>
                                            ...
                                            while (($row_data = $result->fetch_assoc()) !== NULL) {
                                                ...
                                                $or_totale = $or_totale_importo - $or_sconto_coupon + $or_pagamento_prezzo + $or_spedizione;
                                                ...
                                                echo "<td class='text-center'><button class='btn btn-info btn-sm alert-link-ordini-riprisrtina' style='font-weight: normal;' data-href='ordini-elimina-do.php?or_codice=$or_codice' title='eliminato'>ripristina</button></td>";
                                                ...
                                                echo "<button class='btn btn-danger btn-sm elimina' data-href='ordini-elimina-fisicamente-do.php?or_codice=$or_codice' title='Elimina'><i class='fa fa-trash-alt'></i></button>";
                                                echo "</td>";
                                                echo "</tr>";

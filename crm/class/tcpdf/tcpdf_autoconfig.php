...
if (!defined('K_PATH_IMAGES')) {
	$tcpdf_images_dirs = array('images/', K_PATH_MAIN.'examples/images/', K_PATH_MAIN.'images/', '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/', '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/', '/usr/local/apache2/htdocs/tcpdf/images/', K_PATH_MAIN);
...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'logo-login.png')) {
		$tcpdf_header_logo = 'logo-login.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'Lucasweb');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'Lucasweb');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Saggese');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by Studio Saggese\nwww.saggeseonline.com");
}

		...
		<td height="450" valign="top">
			<table width="100%" border="0" border="1">
				...
				<?php
                    ...
                    $querySql = "DELETE FROM pr_prodotti WHERE pr_codice_marchio = $get_mr_codice";
                    ...
                    */
                    ...
                    $querySql_mr = "UPDATE mr_marchi SET mr_timestamp_sincro = '$serialDate' WHERE mr_codice = $get_mr_codice ";

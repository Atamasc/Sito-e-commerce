...
$querySql = "SELECT ct_titolo FROM cc_clienti_categorie INNER JOIN ct_categoria ON ct_id = cc_ct_id WHERE cc_ut_codice = '" . $row_data['ut_codice'] . "' ";
$result = $dbConn->query($querySql);
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 align-self-center">
                                                ...
                                                <div class="user-detail" style="padding-left: 20px">
                                                    <h2 class="name"><?php echo $row_data['ut_ragione_sociale']; ?></h2>
                                                    <p class="designation mb-0"><?php echo $row_data['ut_indirizzo'] . ", " . $row_data['ut_citta'] . " (" . $row_data['ut_provincia'] . ")"; ?></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 text-right align-self-center">
                                                <button type="button" class="btn btn-sm btn-danger">
                                                    <i class="ti-user pr-1"></i>Follow
                                                </button>
                                                <button type="button" class="btn btn-sm btn-success">
                                                    <i class="ti-email pr-1"></i>Message
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="clearfix">
                                    ...
                                    <div class="float-right text-right">
                                        ...
                                        <?php
                                        function pageGetClienteRichieste($ut_email)
                                        {

                                            global $dbConn;
                                            $querySql = "SELECT COUNT(ro_id) FROM ro_richiesta_offerta INNER JOIN le_lead ON le_id = ro_le_id WHERE le_email = '$ut_email' ";
                                            $result = $dbConn->query($querySql);
                                        ...
                                        ?>
                                        <h4><?php echo pageGetClienteRichieste($row_data['ut_email']); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="clearfix">
                                    ...
                                    <div class="float-right text-right">
                                        ...
                                        <?php
                                        function pageGetClienteOmologhe($ut_id)
                                        {

                                            global $dbConn;
                                            $querySql = "SELECT COUNT(om_id) FROM om_omologa WHERE om_ut_id = '$ut_id' ";
                                            $result = $dbConn->query($querySql);
                                            $count = $result->fetch_array()[0];
                                            $result->close();
                                        ...
                                        ?>
                                        <h4><?php echo pageGetClienteOmologhe($get_ut_id); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="clearfix">
                                    ...
                                    <div class="float-right text-right">
                                        ...
                                        <?php
                                        function pageGetClienteQuotazioni($ut_id)
                                        {

                                            global $dbConn;
                                            $querySql = "SELECT COUNT(qt_id) FROM qt_quotazioni INNER JOIN om_omologa ON om_qt_id = qt_id WHERE om_ut_id = '$ut_id' ";
                                            $result = $dbConn->query($querySql);
                                            $count = $result->fetch_array()[0];
                                            $result->close();
                                        ...
                                        ?>
                                        <h4><?php echo pageGetClienteQuotazioni($get_ut_id); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="clearfix">
                                    ...
                                    <div class="float-right text-right">
                                        ...
                                        <?php
                                        function pageGetClienteConferimenti($ut_id)
                                        {

                                            global $dbConn;
                                            $querySql = "SELECT COUNT(cn_id) FROM cn_conferimento INNER JOIN om_omologa ON om_id = cn_om_id WHERE om_ut_id = '$ut_id' ";
                                            $result = $dbConn->query($querySql);
                                            $count = $result->fetch_array()[0];
                                            $result->close();
                                        ...
                                        ?>
                                        <h4><?php echo pageGetClienteConferimenti($get_ut_id); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-30 about-me">
                            <div class="card-body">
                                ...
                                <div class="btn-group info-drop">
                                    <button type="button" class="dropdown-toggle-split text-muted" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="ti-more"></i></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="clienti-mod.php?ut_id=<?php echo $get_ut_id; ?>"><i class="text-success ti-pencil-alt"></i> Modifica dati</a>
                                ...
                                <p>
                                    <b>Referente rifiuti:</b> <?php echo strlen($row_data['ut_ref_rifiuti']) > 0 ? $row_data['ut_ref_rifiuti'] : "Non specificato"; ?>
                                </p>
                                <p>
                                    <b>Referente contabilità:</b> <?php echo strlen($row_data['ut_ref_contabile']) > 0 ? $row_data['ut_ref_contabile'] : "Non specificato"; ?>
                                </p>

                                <ul class="list-unstyled">
                                    <li class="list-item">
                                        <span class="text-success fa fa-users"></span><?php echo strlen($ct_titolo) > 0 ? "Categoria $ct_titolo" : "Non categorizzato"; ?>
                                    </li>
                                    <li class="list-item">
                                        <span class="text-info fa fa-envelope"></span><?php echo $row_data['ut_email']; ?>
                                    </li>
                                    <li class="list-item">
                                        <span class="text-warning fa fa-phone"></span><?php echo $row_data['ut_telefono']; ?>
                                    </li>
                                    <li class="list-item">
                                        <span class="text-success fa fa-id-card-o"></span>P.IVA: <?php echo $row_data['ut_partita_iva']; ?>
                                    </li>
                                    <li class="list-item">
                                        <span class="text-dark fa fa-id-card-o"></span>Cod. Fiscale: <?php echo $row_data['ut_cod_fiscale']; ?>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-group info-drop">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        -->
                                        <a class="dropdown-item" href="richiesta-offerta-gst.php?le_email=<?php echo $row_data['ut_email'] ?>"><i class="text-success fa fa-list"></i> Vai alla lista</a>
                                    </div>
                                </div>
                                <div class="scrollbar max-h-350">
                                    <ul class="list-unstyled">
                                        ...
                                        <?php
                                        pageGetRichieste($row_data['ut_email']);
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-group info-drop">
                                    <button type="button" class="dropdown-toggle-split text-muted" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="ti-more"></i></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="omologa-gst.php?ut_id=<?php echo $get_ut_id; ?>"><i class="text-success fa fa-list"></i> Vedi tutte</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-1 table-bordered table-striped mb-0">
                                        ...
                                        <?php
                                        $querySql =
                                            "SELECT * FROM om_omologa INNER JOIN ut_utenti ON ut_id = om_ut_id WHERE om_id > 0 AND ut_id = '$get_ut_id' ORDER BY om_id DESC LIMIT 0, 5";
                                        $result = $dbConn->query($querySql);
                                        $rows = $dbConn->affected_rows;
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group mb-1">
                                                    <button type="button" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="false">Gestione
                                                    </button>
                                                    <div class="dropdown-menu">
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-group info-drop">
                                    <button type="button" class="dropdown-toggle-split text-muted" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="ti-more"></i></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="conferimento-gst.php?ut_id=<?php echo $get_ut_id; ?>"><i class="text-success fa fa-list"></i> Vedi tutte</a>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-1 table-bordered table-striped mb-0">
                                        ...
                                        $querySql =
                                            ...
                                            "INNER JOIN ut_utenti ON ut_id = om_ut_id " .
                                            "WHERE cn_id > 0 AND ut_id = '$get_ut_id' ORDER BY cn_id LIMIT 0, 5";
                                        $result = $dbConn->query($querySql);
                                        $rows = $dbConn->affected_rows;
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-1 table-bordered table-striped mb-0">
                                        ...
                                        <?php
                                        $querySql = "SELECT * FROM qt_quotazioni INNER JOIN om_omologa ON om_qt_id = qt_id WHERE om_ut_id = '$get_ut_id' ORDER BY qt_id LIMIT 0, 5";
                                        $result = $dbConn->query($querySql);
                                        $rows = $dbConn->affected_rows;

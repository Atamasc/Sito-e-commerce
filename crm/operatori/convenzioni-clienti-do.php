...
if($ca_id > 0) {
    ...
    $querySql =
        "UPDATE ca_convenzioni_clienti SET ca_ut_id = '$ca_ut_id', ca_timestamp_attivazione = '$ca_timestamp_attivazione', ".
    ...
    $querySql =
        "INSERT INTO ca_convenzioni_clienti (ca_cv_id, ca_ut_id, ca_timestamp_attivazione, ca_timestamp_scadenza, ca_stato".
        ") VALUES ('$ca_cv_id', '$ca_ut_id', '$ca_timestamp_attivazione', '$ca_timestamp_scadenza', 1)";
    $result = $dbConn->query($querySql);
    $rows = $dbConn->affected_rows;

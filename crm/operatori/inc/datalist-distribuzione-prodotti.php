            ...
            <div class="table-responsive">
                ...
                <table class="table table-1 table-bordered table-striped mb-0">
                    ...
                    while (($row_data = $result->fetch_assoc()) !== NULL) {
                        ...
                        echo "<a class='btn btn-success btn-sm mb-2' href='distribuzione-prodotti-mod.php?dp_id=$dp_id' title='Modifica'><i class='fas fa-edit'></i></a>&nbsp;";
                        echo "<button class='btn btn-danger btn-sm mb-2 elimina' data-href='distribuzione-prodotti-del-do.php?di_id=$get_di_id&dp_id=$dp_id'><i class='fas fa-trash-alt'></i></button>";
                        echo "</td>";
                        echo "</tr>";

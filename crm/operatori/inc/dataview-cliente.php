                ...
                <table class="table table-1 table-bordered table-striped mb-0">
                    ...
                    function dataviewLoad() {
                        ...
                        while (($row_data = $result->fetch_assoc()) !== NULL) {
                            ...
                            echo "<a class='btn btn-primary btn-sm' href='omologa-add.php?ut_id=$ut_id' title='Omologa'>omologa</a>&nbsp;";
                            echo "<a class='btn btn-orange btn-sm' href='omologa-gst.php?ut_id=$ut_id' title='Storico omologhe'>storico omologhe</a>&nbsp;";

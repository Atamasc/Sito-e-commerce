                        ...
                        <div class="card card-statistics mb-30">
                            <div class="card-body">
                                ...
                                <form method="post" action="newsletter-liste-email-do.php" enctype="multipart/form-data">
                                    ...
                                    <?php
                                    $querySql = "SELECT ne_email FROM ne_newsletter_email WHERE ne_ns_id = $get_ns_id ";
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="ne_lista_email">Nella lista sono presenti <?php echo $count_email; ?> email</label>
                                            <textarea class="form-control" id="ne_lista_email" name="ne_lista_email" placeholder="Email"
                                                      rows="10"><?php echo $ce_email_list; ?></textarea>
                                            <p>Separa le email da un ";"</p>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-1 table-bordered table-striped mb-0">
                                        ...
                                        while (($row_data = $result->fetch_assoc()) !== NULL) {
                                            ...
                                            echo "<button class='btn btn-danger btn-sm elimina' data-href='newsletter-liste-email-del-do.php?ne_ns_id=$get_ns_id&ne_id=$ne_id'>elimina</button>";
                                            echo "</td>";
                                            echo "</tr>";

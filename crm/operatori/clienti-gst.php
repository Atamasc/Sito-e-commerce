                                    ...
                                    <form method="get" action="?" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select class="form-control" id="cc_ct_id" name="cc_ct_id">
                                                ...
                                                <option value=""></option>
                                                <?php //selectClientiCategorie($get_cc_ct_id); ?>
                                            </select>
                                        </div>
                                        -->
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-1 table-bordered table-striped mb-0">
                                            ...
                                            while (($row_data = $result->fetch_assoc()) !== NULL) {
                                                ...
                                                echo "<a class='btn btn-orange btn-sm popup-custom' data-pop-width='1200' data-pop-height='800' href='javascript:;' " .
                                                    "data-href='ordini-prodotti-add.php?ut_codice=$ut_codice&or_timestamp=" . time() . "' title='Ordini'>crea ordine</a>";
                                                echo "</td>";
                                                echo "</tr>";

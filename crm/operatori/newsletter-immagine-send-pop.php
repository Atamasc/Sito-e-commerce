...
while (($row_data_ne = $result_ne->fetch_assoc()) !== NULL) {
    ...
    $corpo_newsletter = "<p>";
    //$corpo_newsletter .= "<strong>".$nl_titolo."</strong><br>";
    $corpo_newsletter .= str_replace("#nominativo#", $row_data_ne['ne_nominativo'], $nl_testo);
    $corpo_newsletter .= "</p>";
    ...
    $mail->Body = convertLink($body_mail, $root_base_path, $time, $ne_email).$tracker;

...
$querySql = "SELECT COUNT(ws_id) FROM ws_wishlist WHERE ws_ut_codice = '$session_cl_codice' AND ws_pr_codice = '$cr_pr_codice' ";
...
if ($rows == 0) {
    ...
    $querySql =
        "INSERT INTO ws_wishlist (ws_ut_codice, ws_pr_codice, ws_timestamp) " .

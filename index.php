            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="section-title">
                        ...
                        <p>I prodotti pi&ugrave; venduti nello store</p>
                    </div>
                    <!-- Section Title Start -->
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="section-title">
                        <h2>Super sconti</h2>
                        <p>Scopri tutti i prodotti in sconto</p>
                    </div>
                    <!-- Section Title -->
                </div>
            </div>
            ...
            <div class="recent-product-slider owl-carousel owl-nav-style">
                ...
                $querySql = "    SELECT * FROM pr_prodotti
                                 WHERE pr_immagine != '' AND pr_stato > 0 AND pr_giacenza > 0 AND pr_prezzo_scontato > 0

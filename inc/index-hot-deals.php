            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4">
                ...
                <div class="hot-deal owl-carousel owl-nav-style">
                    ...
                    while (($row = $result->fetch_assoc()) !== NULL) {
                        ...
                        $mr_marche = getMarca($row['pr_mr_id']);
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="<?php echo $pr_link; ?>" class="thumbnail">
                                    ...
                                    <img class="second-img" data-src="<?php echo $pi_immagine; ?>" alt=""/> </a>
                            ...
                            <div class="product-decs">
                                ...
                                <h3><a href="<?php echo $pr_link; ?>" class="product-link"><?php echo $pr_titolo; ?></a>
                                </h3>
                        ...
                        <div class="product-inner-item">
                            ...
                            <article class="list-product mb-30px">
                                ...
                                <div class="product-decs">
                                    ...
                                    <h2>
                                        <a href="<?php echo $pr_link; ?>" class="product-link"><?php echo $pr_titolo; ?></a>
                                    </h2>
                                    <div class="rating-product">
                                        <?php $media_voto = mediaRecensioni($pr_codice, $dbConn) ?>

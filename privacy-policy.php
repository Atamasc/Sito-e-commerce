...
<html lang="it">
<head>
    <title>Cybek - Privacy Policy</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 corpo">
                    <h4>
                        Informativa sul trattamento dei dati personali secondo quanto stabilito dal REGOLAMENTO (UE) 2016/679 DEL PARLAMENTO EUROPEO E DEL CONSIGLIO del 27 aprile 2016 relativo alla protezione delle persone fisiche, nonch&eacute; alla libera circolazione di tali dati e che abroga la direttiva 95/46/CE (regolamento generale sulla protezione dei dati)
                    </h4>

                    <hr>

                    <h5>Politica sulla riservatezza</h5>
                    <p>Il sito Cybek è di proprietà di Cybek, titolare del trattamento dei Suoi dati personali.

                        Abbiamo adottato questa politica sulla privacy, la quale determina il trattamento delle informazioni raccolte da Cybek, oltre che i motivi per raccolta di certi dati personali a Lei correlati. Pertanto, deve leggere questa politica sulla riservatezza prima di usare il sito Cybek.

                        Trattiamo i Suoi dati personali e garantiamo riservatezza e sicurezza degli stessi.
                    </p>

                    <h5>Informazioni personali raccolte: </h5>
                    Quando visita Cybek, raccogliamo automaticamente certe informazioni sul dispositivo, incluse informazioni su browser web, indirizzo IP, fuso orario e cookie installati sul dispositivo. Inoltre, navigando sul sito, raccogliamo informazioni sulle pagine web o i prodotti visualizzati, siti web o termini di ricerca di riferimento verso il sito e come Lei interagisce con il sito. Indichiamo tali informazioni raccolte automaticamente come “informazioni sul dispositivo”. Inoltre, potremmo raccogliere dati personali che ci fornisce (inclusi senza limitazione nome, cognome, indirizzo, informazioni di pagamento ecc.) durante la registrazione per soddisfare l'accordo.

                    <h5>Perché trattiamo i dati?</h5>
                    ...
                    <br> Per esercitare questi diritti, si prega di contattarci tramite le informazioni di contatto sotto.
                    ...
                    <h5>Collegamenti ad altri siti:</h5>
